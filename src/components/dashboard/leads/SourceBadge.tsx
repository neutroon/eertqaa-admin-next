...
// SVG Icons for different sources
const MessengerIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2C6.36 2 2 6.13 2 11.7c0 2.91 1.19 5.44 3.14 7.17.16.13.26.35.27.57l.05 1.78c.04.57.61.94 1.13.71l1.98-.87c.17-.08.36-.1.55-.06.91.25 1.87.38 2.88.38 5.64 0 10-4.13 10-9.7S17.64 2 12 2zm5.89 7.61l-2.89 4.58c-.46.73-1.45.91-2.13.4l-2.3-1.73c-.17-.13-.41-.13-.59 0l-3.1 2.35c-.42.32-.96-.18-.69-.64l2.89-4.58c.46-.73 1.45-.91 2.13-.4l2.3 1.73c.17.13.41.13.59 0l3.1-2.35c.42-.32.96.18.69.64z" />
    </svg>
);
