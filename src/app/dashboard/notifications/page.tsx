    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-20">
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            إدارة جميع التنبيهات والإشعارات الخاصة بك
          </p>
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-32 text-center">
            ...
            <p className="text-gray-500 mt-2 max-w-sm mx-auto">
              عندما يتم إرسال تنبيهات جديدة لك، ستظهر جميعها في هذه الصفحة
              لتتمكن من متابعتها.
            </p>
          </div>
        )}
        ...
        {notifications.length > 0 && totalPages > 1 && (
          <div
            className="p-6 bg-gray-50/50 border-t border-gray-100 flex items-center justify-center sm:justify-between gap-4"
            dir="ltr"
          >
            ...
            <div
              className="hidden sm:block text-sm text-gray-400 font-medium"
              dir="rtl"
            >
